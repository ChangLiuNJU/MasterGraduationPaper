...
\begin{figure}[!ht]
\centering
\includegraphics[width=0.7\textwidth]{Figure/eva_classification.eps}
\caption{行为分类器准确率}
...
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth]{Figure/path.eps}
...
\centering
	\begin{minipage}{0.33\linewidth}
        \centerline{\includegraphics[width=0.9\textwidth]{Figure/eva_path.eps}}
        \centerline{(a) 角度误差}
    \end{minipage}%
	\begin{minipage}{0.33\linewidth}
        \centerline{\includegraphics[width=0.9\textwidth]{Figure/eva_error_turn.eps}}
        \centerline{(b) 分类后的角度误差}
    \end{minipage}%
    \begin{minipage}{0.33\linewidth}
        \centerline{\includegraphics[width=0.9\textwidth]{Figure/eva_path_users.eps}}
        \centerline{(b) 分类后的角度误差}
    \end{minipage}
\caption{真实环境中的案例评估}
